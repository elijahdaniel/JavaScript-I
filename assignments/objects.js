...
// Mitzi's name
console.log(intern[0].first_name);
...
// Gannie's name
console.log(intern[3].first_name);
...
function kennan() {
  return "Hello, my name is " + intern[1].first_name + "!";
}
...
function antonietta(a, b) {
  return a * b;
}

console.log(antonietta(2, 3));
